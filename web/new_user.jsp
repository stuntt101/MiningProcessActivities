        ...
        <form  id="register_user"    action ="RegisterUser"method="POST"  autocomplete="off">
            <fieldset class="formFieldset"><legend class="formLegend"><b>Register new user</b></legend>
                <table border="0" cellpading="7" cellspacing="7">
                    <tbody>
                        <tr>
                            <td>Username<span  style="color:red">*</span></td> <td><input type="text" name="username" maxlength="45" class="form-control" /></td>
                        </tr>
                        <tr>
                            <td>Password<span  style="color:red">*</span></td> <td><input type="text" id="password"  name="password" maxlength="45" class="form-control" /></td>
                        </tr>
                        <tr>
                            <td>First Name<span  style="color:red">*</span></td> <td><input type="text" id="firstName" name="firstName" maxlength="45" class="form-control" /></td>
                        </tr>
                        <tr>
                            <td>Last Name<span  style="color:red">*</span></td> <td><input type="text"  id="lastName" name="lastName" maxlength="45" class="form-control" /></td>
                        </tr>
                        <tr>
                           <td>Email Address<span  style="color:red">*</span></td> <td><input type="text" id="emailAddress"   name="emailAddress" maxlength="45" /></td>
                        </tr>
                        <tr>
                            <td>Mine Name<span  style="color:red">*</span></td> <td><input type="text" id="mineName" name="mineName" maxlength="45"  /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td></td> <td><button type="submit"  class="button" name="action" value="addUser"  >Save</button> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<button type="reset" class="button"name="clear_text" value="Clear All">Clear All</button></td>
                        </tr>
